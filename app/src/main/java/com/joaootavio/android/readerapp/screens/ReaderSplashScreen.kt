package com.joaootavio.android.readerapp.screens
...
@Composable
fun ReaderSpalshScreen(navController: NavController) {
    val scale = remember {
        Animatable(0f)
    }
...
fun ReaderSplashScreenPreview() {
    ReaderSpalshScreen(navController = NavController(LocalContext.current))
}